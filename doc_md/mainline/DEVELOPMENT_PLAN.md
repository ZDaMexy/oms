...
状态：R0/R1 已解除；三态 slot/precedence、内部 semantic taxonomy、neutral lane identity/topology、config bucket explicit-presence、event envelope/order 与 capability negotiation/禁止 authority 七个切片已完成，其余共同合同待续。
