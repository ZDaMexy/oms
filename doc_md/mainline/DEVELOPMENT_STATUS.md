...
| BMS 全量测试 | **961/961** | 最近一次全量 `osu.Game.Rulesets.Bms.Tests`（2026-06-23 K12 后重跑，含 BGA Phase 5/5.1/5.2 + 选歌预览泄漏修复 + 判定 parity 契约 29 项） |
...
| 1.1.12 测试矩阵与 release gate | 进行中 | Mania skin 92/92、BMS 聚焦 111/111、osu.Game.Tests 18/18 已复核；BMS 全量 **961/961** 已于 2026-06-23 复核（见上「开发指标」），mania 全量与 scratch bridge 继续沿用 2026-04-24 快照 |
