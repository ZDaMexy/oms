...
- 原 V-001～V-004 仍为 0/4、V-005 未签收；星轨总体画面体验不通过，具体场景、声音、设备和长期体验未提供单项证据，不代填矩阵。自动安装与恢复通过不代表整个 Skin V1 或发行版本完成；程序化 `OmsSkin` 仅保留历史对照和待签收移除边界，不再作为 canonical 损坏时的替代外观。
