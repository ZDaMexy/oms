...
- PLAN 只保留 parity 守门、P1-E/P1-G 人工协作和“未来反馈须另立专题”；移除已删除常驻 card 的实施清单与已完成阶段史。
- README 降为兼容路由；CONSTRAINTS 只保留稳定窗口/poor/release、results 与 HUD 禁止越权合同，不再混写进度或把被删 card 当当前 authority。
- 当前功能与产品结论未变；本次仅改文档，未改代码，未运行产品测试或 Release。
