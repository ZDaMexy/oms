...
| 子线 | 负责范围 | 当前判定 | 下一道门 |
| --- | --- | --- | --- |
| [P1-A](P1-A/DEVELOPMENT_STATUS.md) | 产品面、Skin V1、release gate | C1～C6已闭合，公开脚本/授权UI、双ruleset候选、最终整包reload与G1自动门通过；当前`6/7 closed，C7 active`，原`V-001`～`V-004`签收0/4，新增V-005未签收 | C7 canonical双包/完整Authoring Kit、fallback接管与自动release；程序化OmsSkin继续保留，Skin V1/release仍未完成 |
...
| [P1-F](P1-F/DEVELOPMENT_STATUS.md) | 离线发行物与覆盖更新 | portable/custom-root 链存在；包内说明待修 | 保持便携模式与 storage.ini，复核非便携覆盖及候选包冷启动 |
