...
| 子线 | 负责范围 | 当前判定 | 下一道门 |
| --- | --- | --- | --- |
| [P1-A](P1-A/DEVELOPMENT_STATUS.md) | 产品面、Skin V1、release gate | `SV1-0` 全过；managed `.osk` BMS Note/LN head/body/tail 四组件自动 gate 闭合，`V-001`～`V-004` 签收 0/4；`SV1-2` 首个 authority/path preflight 已落但无生产调用者 | 继续 R3 不可变 revision capsule、production folder factory、scanner/mutation ownership 与整包原子重载；`SV1-1`/Skin V1 整体仍未完成 |
