...
P1-A 负责 Skin V1、共享皮肤产品面与 release gate。当前 `SV1-0` 已闭门，managed `.osk` BMS 普通短键与长条 head/body/tail 的首个 Note/LN 产品纵切已闭合自动、合同、安全和回退 gate，`V-001`～`V-004` 集中待验收；这不等于 `SV1-1` 完成或产品交付，工程依赖已允许进入下一门 `SV1-2`，Skin V1 整体仍不可用。
