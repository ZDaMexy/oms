...
| 4 | `SV1-2` G1 安全存储与原子重载 | **进行中** | 启动发现/选择及现有settings managed delete玩家可达；rename/import后端仍无caller/stager/UI，thin stager/caller当前NO-GO；external与atomic reload/detach未交付 |
