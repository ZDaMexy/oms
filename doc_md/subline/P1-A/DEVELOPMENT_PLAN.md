...
| 4 | `SV1-2` G1 安全存储与原子重载 | **进行中** | 启动发现/选择及现有settings managed delete玩家可达；rename/import后端仍无caller/stager/UI，thin stager/caller当前NO-GO；external未交付，current managed atomic reload/detach经2026-08-09产品链审计为NO-GO |
