...
namespace osu.Game.Overlays.Settings.Sections.Input
{
    public partial class BindingSettings : SettingsSubsection
    {
        ...
        public override IEnumerable<LocalisableString> FilterTerms => base.FilterTerms.Concat(new LocalisableString[] { @"keybindings", @"controls", @"keyboard", @"keys", @"buttons", @"joystick", @"gamepad", @"controller", @"xinput" });
