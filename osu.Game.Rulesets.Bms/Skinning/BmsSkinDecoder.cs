...
namespace osu.Game.Rulesets.Bms.Skinning
{
    ...
    public class BmsSkinDecoder
    {
        ...
        private static readonly Regex per_lane_image = new Regex(@"^(NoteImage|KeyImage|LaneBackgroundImage|LaneDividerImage|KeyFlashImage|HitLightingImage|HoldLightImage|MineHitImage)(\d+|S)([HLTD])?$", RegexOptions.Compiled);
