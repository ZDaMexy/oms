...
namespace osu.Game.Rulesets.Bms.Skinning
{
    ...
    public class BmsSkinDecoder
    {
        ...
        // Per-lane texture keys: NoteImage{lane}[H|L|T] / KeyImage{lane}[D], lane = digits or "S" (scratch).
        private static readonly Regex per_lane_image = new Regex(@"^(NoteImage|KeyImage)(\d+|S)([HLTD])?$", RegexOptions.Compiled);
