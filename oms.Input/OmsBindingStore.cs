...
namespace oms.Input
{
    ...
    public class OmsBindingStore
    {
        private static readonly OmsBinding[] default_5k_bindings =
        {
            ...
            new OmsBinding(OmsAction.Key1P_4, InputKey.L),
            new OmsBinding(OmsAction.Key1P_5, InputKey.Semicolon),
            new OmsBinding(OmsAction.UI_LaneCoverFocus, InputKey.W),
            new OmsBinding(OmsAction.UI_PreStartHold, InputKey.Q),
        };
        ...
        private static readonly OmsBinding[] default_7k_bindings =
        {
            ...
            new OmsBinding(OmsAction.Key1P_4, InputKey.Space),
            new OmsBinding(OmsAction.Key1P_5, InputKey.L),
            new OmsBinding(OmsAction.Key1P_6, InputKey.Semicolon),
            new OmsBinding(OmsAction.Key1P_7, InputKey.Quote),
            new OmsBinding(OmsAction.UI_LaneCoverFocus, InputKey.W),
            new OmsBinding(OmsAction.UI_PreStartHold, InputKey.Q),
        };
        ...
        private static readonly OmsBinding[] default_9k_bindings =
        {
            ...
            new OmsBinding(OmsAction.Key9K_6, InputKey.K),
            new OmsBinding(OmsAction.Key9K_7, InputKey.L),
            new OmsBinding(OmsAction.Key9K_8, InputKey.Semicolon),
            new OmsBinding(OmsAction.Key9K_9, InputKey.Quote),
            new OmsBinding(OmsAction.UI_LaneCoverFocus, InputKey.W),
            new OmsBinding(OmsAction.UI_PreStartHold, InputKey.Q),
        };
        ...
        private static readonly OmsBinding[] default_14k_bindings =
        {
            ...
            new OmsBinding(OmsAction.UI_LaneCoverFocus, InputKey.Y),
            new OmsBinding(OmsAction.UI_PreStartHold, InputKey.T),
        };
