...
- [gameplay skin config presence](reference_gameplay_skin_config_presence.md) — bucket/legacy mania scalar/indexed-array/known-global-colour accepted presence、per-index mask、closed colour surface、synthetic default、native mutation 与 decoder authority 地雷。
