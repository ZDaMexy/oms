...
- [gameplay skin config presence](reference_gameplay_skin_config_presence.md) — bucket/legacy mania scalar/indexed-array/global/per-column-colour/bucket-global/lane-resource accepted presence、semantic mapping、per-index mask、synthetic default 与 decoder authority 地雷。
