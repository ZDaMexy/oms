...
- 第十九切验证时为 focused **31/31**、BMS skin relevant **332/332**、BMS full **1188/1188**、Release Rebuild **0 error / 20 warnings**。该切仍只是 accepted provenance：geometry 尚缺 finite/正值/range/屏内/不重叠 validation 与唯一 resolved layout snapshot；除其后 native BMS 普通短键窄纵切外，真实 resource validation/materialization 仍需 package-scoped authority/containment、共享资源名/animation codec、解码预算与 concrete owner/thread-affinity。Skin V1 仍不可用。
