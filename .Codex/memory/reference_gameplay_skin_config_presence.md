...
description: Skin V1 configuration bucket/scalar/indexed-array accepted presence、legacy mania synthetic default 与 decoder authority 地雷
metadata:
  node_type: memory
  type: reference
---
...
- 颜色/resource 字典、`NoteBodyStyle` 与 `[General] Version` 仍须分切。
